<template>
  ...
  <nav class="bg-gray-100 dark:bg-gray-600">
      ...
      <div class="flex justify-between">
        ...
        <div class="flex w-full justify-between">
          ...
          <div class="hidden md:flex items-center space-x-3 mr-5">
            ...
            <router-link to="/resources" class="py-3 px-3 text-main hover:text-main-light">Resource Types</router-link>
    ...
    <div class="mobile-menu md:hidden bg-main-dark" :class="menuClass">
      ...
      <router-link to="/resources"  @click="toggleMenu()" class="block py-2 px-4 text-sm hover:bg-secondary">Resource Types</router-link>
